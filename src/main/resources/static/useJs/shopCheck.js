...
function checkAll() {
    ...
    // 값이 비었는지 확인하기 위한 리스트
    let checkVal = [$('#shopId').val(), $("#shopPw").val(), $("#shopPw2").val(), $('#shopName').val(), $('#shopTel').val(), $("#ownerName").val(), $("#ownerPh").val(), $("#ownerMail").val(), $(".ownerGen").val(), $('#shopAddrNum').val(), $('#ownerWord').val()]

    // 값이 없을때를 알리기 위한 리스트
    let checkSpan = [$('.checkId'), $('.checkPw'), $('.checkPw2'), $('.checkShopName'), $('.checkTel'), $('.checkName'), $('.checkPh'), $('.checkMail'), $('.checkGen'), $('.checkAddr'), $('.checkWord')];
